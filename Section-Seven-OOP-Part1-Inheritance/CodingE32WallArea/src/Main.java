...
// parameters (no-arg constructor). The second constructor has parameters width and height of type
// double, and it needs to initialize the fields. In case the width is less than 0 it needs to set the
