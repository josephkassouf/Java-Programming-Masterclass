// POLYMORPHISM CODING EXERCISE 40
// 
// Description:
// 
...
// 
// Two getter methods should also be defined here for the member variables cylinders and name. All methods
// have public access.
// 
// The other three classes mentioned above are sub-classes of Car. These classes have no member variables
// and the constructor for each will call the parent constructor for object instantiation. Each of these classes
// will override the three parent methods startEngine, accelerate, and brake. The return messages for these methods
...
//    Car -> accelerate()
//    Car -> braking()
//    Mitsubishi Outlander VRX 4WD -> startEngine()
//    Mitsubishi Outlander VRX 4WD -> accelerate()
//    Mitsubishi Outlander VRX 4WD -> braking()
//    Ford Falcon -> startEngine()
//    Ford Falcon -> accelerate()
//    Ford Falcon -> braking()
//    Holden Commodore -> startEngine()
//    Holden Commodore -> accelerate()
//    Holden Commodore -> braking()
