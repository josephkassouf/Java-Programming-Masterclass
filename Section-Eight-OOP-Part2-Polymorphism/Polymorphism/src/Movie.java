public class Movie {
    ...
    public static Movie getMovie(String genre, String title) {
...
class Comedy extends Movie {
    ...
    public void watchMovie() {
        super.watchMovie();
        System.out.printf("..%s%n".repeat(3), "Something Funny Happens", "Something Even Funnier Happens", "Something good happens");
    }
